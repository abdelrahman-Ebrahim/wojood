    ...
    <div className="mt-16 grid grid-cols-2 gap-5 md:grid-cols-4">
      ...
      <div className="flex flex-col text-center items-center gap-4 even:mt-20 sm:even:mt-12 ">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <p className="font-semibold text-xl text-[#390089]">{t("text1")}</p>
          <p className="font-normal text-lg text-[#444444]">{t("subtext1")}</p>
        </div>
      </div>
      {/* Second card */}
      <div className="flex flex-col text-center items-center gap-4 even:mt-20 sm:even:mt-12">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          ...
          <p className="font-normal text-lg text-[#444444]">{t("subtext2")}</p>
        </div>
      </div>
      {/* Third card */}
      <div className="flex flex-col text-center items-center gap-4 even:mt-20 sm:even:mt-12">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          ...
          <p className="font-normal text-lg text-[#444444]">{t("subtext3")}</p>
        </div>
      </div>
      ...
      <div className="flex flex-col text-center items-center gap-4 even:mt-20 sm:even:mt-12">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          ...
          <p className="font-normal text-lg text-[#444444]">{t("subtext4")}</p>
        </div>
      </div>
    </div>
  );
