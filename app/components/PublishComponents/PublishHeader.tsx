...
const PublishHeader = () => {
  ...
  return (
    <div className="my-4">
      <div className="relative mb-10 flex flex-col lg:flex-row items-center justify-between rounded-[16px] bg-[#6152C1]">
        <div className="relative max-w-screen px-5 py-8 lg:py-4 xl:py-8 lg:p-[60px] text-center md:text-start text-white">
          <h2 className="text-2xl md:text-[37px] font-bold mb-4 leading-9">
            {t("title")}
          </h2>
          <p>{t("subtitle")}</p>
        </div>
        ...
        <Image
          ...
          width={756}
          height={306}
          className="block lg:hidden h-auto w-full rounded-b-[16px]"
        />
      </div>
    </div>
  );
